...
const Home = () => {
    ...
    useEffect(() => {
        ...
        const token =
            "eyJhbGciOiJIUzI1NiJ9.eyJpYXQiOiIxNjg1MTA3NTEwIiwiaWQiOiIxIn0.KY21wUFm88CkHlu9adS_BCXbGhyxfvP8I1Z3kax4vYc";
        ...
        axios.get("/api/konsultasi_flash_auth", {
            headers: {
            ...
            (resp) => {
                ...
                const konsultasi_id = 3; // ini bisa dapet dari /api/list_konsultasi

                // menggunakan endpoint /api/live_konsultasi/<konsultasi_id>?token=<flash_token>, kita
                // terhubung dengan sumber event baru
                const sse = new EventSource(
                    "/api/live_konsultasi/" + String(konsultasi_id) + "?token=" +
                    encodeURI(flash_token),
                );
    ...
    return (
        <div className="flex flex-col">
            <div
                className="grid place-items-center h-screen pl-5 pr-5 sm:pl-6 sm:pr-6 xl:pl-[100px] xl:pr-[100px]"
            ...
            >
                <div className="flex flex-col justify-center items-center gap-7 container mx-auto">
                    ...
                    <h1 className="text-center leading-10 sm:leading-[3.75rem] home-heading font-semibold">
                        Welcome to Fundify <br className="hidden md:block" />{" "}
                        consult your business now!
                    </h1>
                    <p className="text-center max-w-[1054px] font-normal text-lg text-[#6B7280] leading-6 md:leading-7 home-hero-paragraph">
                    ...
                    >
                        <Button className={"bg-[#1496FF] text-white border-none text-xl"}>
                            Consult now
                        </Button>
                        <p className="font-semibold text-xl text-[#111827] leading-7">
                            Learn more
                        </p>
                    </div>
                </div>

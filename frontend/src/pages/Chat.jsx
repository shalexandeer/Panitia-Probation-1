            ...
            <div className='container mx-auto grid grid-cols-[30%_1fr] pt-11 gap-14'>
                ...
                <div className='border rounded-[1rem_!important]'>
                    <Card className={'rounded-[1rem_!important]  '}>
                        <Card.Body>
                            <div>
                                <ConsultantCard className={'p-[2rem_4rem_1rem_3rem]'} showDivider={false} />
...
const SearchInput = () => {
    return <input placeholder='search' className='p-3 border w-full rounded-lg'></input>;
};
...
const ConsultantCard = ({ className, showDivider }) => {
    return (
        <div className={`${className}`}>
            ...
            <div className={`divider m-[0px_!important] pt-4 ${showDivider == false && 'hidden'} `}></div>
        </div>
    );
};
